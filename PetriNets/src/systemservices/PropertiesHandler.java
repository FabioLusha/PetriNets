...
public class PropertiesHandler {
    ...
    public static final Path DEFAULT_TEST_SAVING_DIR = FileSystems.getDefault().getPath("test","data", "test_nets.xml");
    ...
    public static void initializeRepositoryProperties() throws PropertiesInitializationException {
        ...
        Path repoPropDir = PROPERTIES_PATH.resolveSibling(REPO_PROPERTIES_PATH);
