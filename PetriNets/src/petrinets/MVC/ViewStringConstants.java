...
public class ViewStringConstants {
    ...
    public static final String ERR_MSG_DESERIALIZATION_FAILED = "Attenzione! Non e' stato possibile caricare le reti salvate. E' stato inizializzato un nuovo archivio.";
    ...
    public static final String[] CHANGE_PETRI_NET_OPTIONS = { "Modifica valori delle marcature dei posti", "Modifica valori dei pesi delle relazioni di flusso",
	...
	public static final String INSERT_NEW_MARC = "Inserisci il nuovo valore della marcatura del posto: \n > ";
	public static final String INSERT_NEW_COST = "Inserisci il nuovo valore del peso della relazione di flusso: \n > ";
    ...
    public static final String MSG_AUTOMATIC_FIRE_TRANSITION = "Transizione scattata automaticamente %s.\n";
